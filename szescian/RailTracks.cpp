	...
	: Complex3D(4, x, y, z)
{
	...
	_elements[0]->SetScale(14, 2, 4);
	_elements[1]->SetScale(14, 2, 4);
	...
	_elements[0]->SetPosition(0, -0.5, -5);
	_elements[1]->SetPosition(0, -0.5, 5);
	_elements[2]->SetPosition(-4, 2, 0);
	_elements[3]->SetPosition(4, 2, 0);
}